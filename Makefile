...
compiler: compiler.lex.yy.c compiler.tab.c compilateur/table_symboles.c compilateur/table_asm.c compilateur/table_blocs_conditionnels.c logger/logger.c
	gcc -o compiler compiler.tab.c logger/logger.c compilateur/table_symboles.c compilateur/table_asm.c compilateur/table_blocs_conditionnels.c compiler.lex.yy.c lib/libfl.a
